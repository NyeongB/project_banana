...
CREATE OR REPLACE VIEW AD_APPLYLIST_VIEW
AS
SELECT J.ID AS ID , (CASE AT.ADV_LOC WHEN 'Top' THEN '상단광고' WHEN 'Right' THEN '우측광고' WHEN 'Bottom' THEN '하단광고' ELSE '광고' END ) AS ADLOC, AP.START_DATE AS ADSDATE, AP.END_DATE AS ADEDATE, AP.PHOTO , AP.L_LINK ADLINK, AP.CONTENT
