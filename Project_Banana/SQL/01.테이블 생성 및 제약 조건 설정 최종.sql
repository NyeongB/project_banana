...
-- 공동구매 RATING CLOUMN 추가 
ALTER TABLE G_POST_JJIM ADD(RATING NUMBER(3) DEFAULT 0.0);
-- 실수형 변경
ALTER TABLE G_POST_JJIM DROP COLUMN RATING;
ALTER TABLE G_POST_JJIM ADD(RATING NUMBER(3,1) DEFAULT 0.0);