...
CREATE TABLE "R_POST" (
	...
	"USER_CODE"          VARCHAR2(20)   NOT NULL, -- 작성한 사용자 식별 코드
...
CREATE TABLE "G_POST" (
	...
	"USER_CODE"    VARCHAR2(20)   NOT NULL, -- 등록한 사용자 식별 코드
...
CREATE TABLE "J_POST" (
	...
	"USER_CODE"         VARCHAR2(20)   NOT NULL, -- 사용자 식별 코드
	"G_CATE_CODE"       VARCHAR2(20)   NOT NULL, -- 공동구매 카테고리 식별 코드
	"TITLE"             VARCHAR2(100)  NOT NULL, -- 글제목
	"CONTENT"           VARCHAR2(4000) NOT NULL, -- 글내용
	"WDATE"             DATE          DEFAULT SYSDATE NOT NULL , -- 작성일시
...
CREATE TABLE "RR_OFFER" (
	...
	"RR_REQ_CODE"  VARCHAR2(20) NOT NULL, -- 역렌트 요청 게시물 등록 코드
	"USER_CODE"    VARCHAR2(20) NOT NULL, -- 신청한 사용자 식별 코드
	"DATE"         DATE        DEFAULT SYSDATE NOT NULL , -- 작성 일시
	"COST"         NUMBER(12)   NOT NULL, -- 비용(일단위)
	"DEPOSIT"      NUMBER(12)   NOT NULL, -- 보증금
	"BRAND"        VARCHAR2(50) NULL      -- 브랜드명
);
...
CREATE TABLE "USER" (
	"USER_CODE" VARCHAR2(20) NOT NULL, -- 사용자 식별 코드
	"DATE"      DATE        DEFAULT SYSDATE NOT NULL  -- 사용자 등록 일시
);

-- 사용자 등록
ALTER TABLE "USER"
	ADD
		CONSTRAINT "PK_USER" -- 사용자 등록 기본키
		PRIMARY KEY (
			"USER_CODE" -- 사용자 식별 코드
		);
...
CREATE TABLE "ADMIN" (
	...
	"DATE"       DATE        DEFAULT SYSDATE NOT NULL , -- 관리자 등록 일시
...
CREATE TABLE "SOSANG_APPLY" (
	...
	"DATE"              DATE         DEFAULT SYSDATE NOT NULL  -- 신청일시
);
...
CREATE TABLE "LEAVE" (
	...
	"DATE"            DATE        DEFAULT SYSDATE NOT NULL  -- 탈퇴일시
);
...
CREATE TABLE "NOTICE" (
	...
	"CONTENT"     VARCHAR2(4000) NOT NULL, -- 글내용
	"FILE"        VARCHAR2(4000) NOT NULL, -- 첨부파일
	"DATA"        DATE          DEFAULT SYSDATE NOT NULL , -- 작성 일시
	"VIEWS"       NUMBER(12)    DEFAULT 0 NOT NULL  -- 조회수
);
...
CREATE TABLE "G_APPLY" (
	...
	"G_POST_CODE"     VARCHAR2(20) NOT NULL, -- 공통협력구매 게시물 등록코드
	"USER_CODE"       VARCHAR2(20) NOT NULL, -- 신청한 사용자 식별 코드
	"DATE"            DATE        DEFAULT SYSDATE NOT NULL , -- 신청일시(결제일시)
...
CREATE TABLE "J_REPLY" (
	...
	"USER_CODE"     VARCHAR2(20)   NOT NULL, --  작성한 사용자 식별코드
	"LEVEL"         NUMBER(1)      NOT NULL, -- 댓글 레벨
	"WDATE"         DATE          DEFAULT SYSDATE NOT NULL , -- 작성 일시
	"REPLY"         VARCHAR2(4000) NOT NULL  -- 댓글내용
);
...
CREATE TABLE "J_REPLY_REPORT" (
	...
	"USER_CODE"              VARCHAR2(20) NOT NULL, -- 신고한 사용자 식별 코드
	"DATE"                   DATE        DEFAULT SYSDATE NOT NULL  -- 신고 일시
);
...
CREATE TABLE "RR_OFFER_REPORT" (
	...
	"USER_CODE"             VARCHAR2(20) NOT NULL, -- 신고한 사용자 식별 코드
	"POST_REPORT_TYPE_CODE" VARCHAR2(20) NOT NULL, -- 게시물 신고 유형 코드
	"DATE"                  DATE        DEFAULT SYSDATE NOT NULL  -- 신고일시
);
...
CREATE TABLE "R_SUCCESS" (
	...
	"R_APPLY_CODE"    VARCHAR2(20) NOT NULL, -- 렌트 이용 신청코드
	"ACCEPT_DATE"     DATE        DEFAULT SYSDATE NOT NULL , -- 대여자 수락일시
	"POINT_LIST_CODE" VARCHAR2(20) NOT NULL  -- 포인트 내역 등록 식별 코드
);
...
CREATE TABLE "G_SUCCESS" (
	...
	"G_POST_CODE"     VARCHAR2(20) NOT NULL, -- 공통협력구매 게시물 등록코드
	"DATE"            DATE        DEFAULT SYSDATE NOT NULL , -- 성사 일시
	"POINT_LIST_CODE" VARCHAR2(20) NOT NULL  -- 포인트 내역 등록 식별 코드
);
...
CREATE TABLE "CREDIT_SCORE" (
	...
	"DATE"              DATE        DEFAULT SYSDATE NOT NULL , -- 일시
	"USER_CODE"         VARCHAR2(20) NOT NULL  -- 사용자 식별 코드
);
...
CREATE TABLE "CONNECTION" (
	...
	"USER_CODE"       VARCHAR2(20) NOT NULL, -- 사용자 식별 코드
	"DATE"            DATE        DEFAULT SYSDATE NOT NULL  -- 접속 일시
);
...
-- 사용자 지역 카테고리
CREATE TABLE "LOC" (
	"LOC_CODE"  VARCHAR2(20) NOT NULL, -- 사용자 지역 카테고리 식별 코드
	"LOC_BCODE" VARCHAR2(20) NOT NULL, -- 시/도 분류 코드
	"LOC_MCODE" VARCHAR2(20) NOT NULL, -- 시/군/구 분류 코드
...
ALTER TABLE "LOC"
	ADD
		CONSTRAINT "PK_LOC" -- 사용자 지역 카테고리 기본키
		PRIMARY KEY (
			"LOC_CODE" -- 사용자 지역 카테고리 식별 코드
		);
...
CREATE TABLE "R_USER_RETURN" (
	...
	"RETURN_STATE"       NUMBER(1)    NOT NULL, -- 반납상태
	"POINT_LIST_CODE"    VARCHAR2(20) NULL      -- 포인트 내역 등록 식별 코드
);
...
CREATE TABLE "R_REPORT_OBJ" (
	...
	"R_DEAL_REPORT_CODE" VARCHAR2(20)   NOT NULL, -- 렌트 거래 신고 코드
	"DATE"               DATE          DEFAULT SYSDATE NOT NULL , -- 이의제기 일시
...
CREATE TABLE "ADV_APPLY_ACCEPT" (
	...
	"ADV_APPLY_CODE"        VARCHAR2(20) NOT NULL, -- 광고신청코드
	"ADMIN_CODE"            VARCHAR2(20) NOT NULL, -- 관리자 등록 코드
	"DATE"                  DATE        DEFAULT SYSDATE NOT NULL  -- 광고 수락 일시
);
...
CREATE TABLE "J_REPLY_LIKE" (
	...
	"J_REPLY_CODE"      VARCHAR2(20) NOT NULL, -- 자율협력구매 댓글 식별코드
	"USER_CODE"         VARCHAR2(20) NOT NULL, -- 사용자 식별 코드
	"DATE"              DATE        DEFAULT SYSDATE NOT NULL  -- 좋아요일시
);
...
CREATE TABLE "G_REPLY_LIKE" (
	...
	"G_REPLY_CODE"      VARCHAR2(20) NOT NULL, -- 공통협력구매 댓글 식별 코드
	"USER_CODE"         VARCHAR2(20) NOT NULL, -- 사용자 식별 코드
	"DATE"              DATE        DEFAULT SYSDATE NOT NULL  -- 좋아요 일시
);
...
CREATE TABLE "G_RETURN_ITEM" (
	...
	"REFUND_DATE"             DATE         NULL,     -- 환불 일시
	"RETURN_DATE"             DATE        DEFAULT SYSDATE NOT NULL , -- 상품반환일시
	"POINT_LIST_CODE"         VARCHAR2(20) NOT NULL  -- 포인트 내역 등록 식별 코드
);
...
CREATE TABLE "J_REAPPLY" (
	...
	"DATE"             DATE        DEFAULT SYSDATE NOT NULL  -- 재입력 일시
);
...
CREATE TABLE "RR_DEAL_SUCESS" (
	...
	"RR_OFER_CODE"        VARCHAR2(20) NOT NULL, -- 역렌트 제공 게시물 등록코드
	"DATE"                DATE        DEFAULT SYSDATE NOT NULL , -- 역렌트 거래 수락일시(결제 일시)
	"POINT_LIST_CODE"     VARCHAR2(20) NOT NULL  -- 포인트 내역 등록 식별 코드
);
...
CREATE TABLE "J_SUCESS" (
	...
	"J_POST_CODE"     VARCHAR2(20) NOT NULL, -- 자율협력구매 게시물 등록 코드
	"POINT_LIST_CODE" VARCHAR2(20) NOT NULL, -- 포인트 내역 등록 식별 코드
	"DATE"            DATE        DEFAULT SYSDATE NOT NULL  -- 성사일시
);
...
CREATE TABLE "RR_REVIEW" (
	...
	"DATE"                DATE          DEFAULT SYSDATE NOT NULL , -- 역렌트 리뷰 작성 일시
...
CREATE TABLE "G_DEAL_REPORT" (
	...
	"DATE"                    DATE          DEFAULT SYSDATE NOT NULL , -- 신고일시
	"FILE"                    VARCHAR2(2000) NOT NULL, -- 첨부파일
	"CONTENT"                 VARCHAR2(4000) NOT NULL, -- 신고내용
	"DEAL_REPORTER_TYPE_CODE" VARCHAR2(20)   NOT NULL  -- 거래 신고자 유형 코드
);
...
CREATE TABLE "G_DEAL_REPORT_PROC" (
	...
	"ADMIN_CODE"                 VARCHAR2(20)   NOT NULL, -- 관리자 등록 코드
	"DEAL_REPORT_PROC_TYPE_CODE" VARCHAR2(20)   NOT NULL, -- 거래 신고처리 유형 코드
	"DATE"                       DATE          DEFAULT SYSDATE NOT NULL , -- 신고 처리 일시
	"ANSWER"                     VARCHAR2(4000) NOT NULL, -- 신고 처리 답변
	"OUT_CODE"                   VARCHAR2(20)   NULL      -- 아웃 내역 등록 코드
);
...
CREATE TABLE "RR_USER_RETURN" (
	"RR_USER_RETURN_CODE" VARCHAR2(20) NOT NULL, -- 역렌트 이용자 반납 코드
	"RR_DEAL_SUCESS_CODE" VARCHAR2(20) NOT NULL, -- 역렌트 거래 성사 등록 코드
	"RETURN_DATE"         DATE         NOT NULL, -- 반납예정 일시
	"RETURN_STATE"        NUMBER(1)    NOT NULL  -- 반납상태
);
...
CREATE TABLE "J_RETURN_ITEM" (
	...
	"RETURN_DATE"             DATE        DEFAULT SYSDATE NOT NULL , -- 상품반환 일시
	"POINT_LIST_CODE"         VARCHAR2(20) NOT NULL  -- 포인트 내역 등록 식별 코드
);
...
CREATE TABLE "J_COST_DROP" (
	"J_COST_DROP_CODE" VARCHAR2(20) NOT NULL, -- 자율협력구매 가격 하락 코드
	"J_POST_CODE"      VARCHAR2(20) NOT NULL, -- 자율협력구매 게시물 등록 코드
	"DATE"             DATE        DEFAULT SYSDATE NOT NULL , -- 하락일시
...
CREATE TABLE "ALARM" (
	...
	"USER_CODE"               VARCHAR2(20)   NOT NULL, -- 사용자 식별 코드
	"DATE"                    DATE          DEFAULT SYSDATE NOT NULL , -- 알림 일시
...
CREATE TABLE "FLLOW_LIST" (
	...
	"USER"            VARCHAR2(20) NOT NULL, -- 주체 아이디
	"FLLOW"           VARCHAR2(20) NOT NULL, -- 팔로워 아이디
	"DATE"            DATE        DEFAULT SYSDATE NOT NULL  -- 팔로우 일시
);
...
CREATE TABLE "G_RECEIPT_FILE" (
	"G_RECEIPT_FILE_CODE" VARCHAR2(20)   NOT NULL, -- 영수증 첨부 코드
	"G_SUCCESS_CODE"      VARCHAR2(20)   NOT NULL, -- 공통협력구매 거래 성사 코드
	"RECEIPT"             VARCHAR2(4000) NOT NULL, -- 영수증 사진
	"DATE"                DATE          DEFAULT SYSDATE NOT NULL  -- 영수증 첨부 일시
);

-- 영수증 첨부
ALTER TABLE "G_RECEIPT_FILE"
	ADD
		CONSTRAINT "PK_G_RECEIPT_FILE" -- 영수증 첨부 기본키
		PRIMARY KEY (
			"G_RECEIPT_FILE_CODE" -- 영수증 첨부 코드
		);
...
CREATE TABLE "G_ATTENDANCE" (
	...
	"G_SUCCESS_CODE"    VARCHAR2(20) NOT NULL, -- 공통협력구매 거래 성사 코드
	"ATTENDANCE_STATE"  NUMBER(1)    NOT NULL, -- 출/결석 상태
	"DATE"              DATE        DEFAULT SYSDATE NOT NULL  -- 출/결석일시
);
...
CREATE TABLE "J_ATTENDANCE" (
	...
	"J_SUCESS_CODE"     VARCHAR2(20) NOT NULL, -- 자율협력구매 거래성사 코드
	"ATTENDANCE_STATE"  NUMBER(1)    NOT NULL, -- 출/결석 상태
	"DATE"              DATE        DEFAULT SYSDATE NOT NULL  -- 출/결석 일시
);
...
CREATE TABLE "SOSANG_APPLY_ACCEPT" (
	...
	"SOSANG_APPLY_CODE"        VARCHAR2(20) NOT NULL, -- 소상공인회원 신청코드
	"ADMIN_CODE"               VARCHAR2(20) NOT NULL, -- 관리자 등록 코드
	"DATE"                     DATE        DEFAULT SYSDATE NOT NULL  -- 수락일시
);
...
CREATE TABLE "J_POST_JJIM" (
	...
	"J_POST_CODE"      VARCHAR2(20) NOT NULL, -- 자율협력구매 게시물 등록 코드
	"USER_CODE"        VARCHAR2(20) NOT NULL, -- 사용자 식별 코드
	"DATE"             DATE        DEFAULT SYSDATE NOT NULL  -- 찜한 일시
);
...
CREATE TABLE "G_REPLY_REPORT_PROC" (
	...
	"G_REPLY_REPORT_CODE"       VARCHAR2(20) NOT NULL, -- 공통 협력 구매 댓글 신고 코드
	"ADMIN_CODE"                VARCHAR2(20) NOT NULL, -- 관리자 등록 코드
	"DATE"                      DATE        DEFAULT SYSDATE NOT NULL , -- 신고처리 일시
...
CREATE TABLE "JOIN" (
	...
	"PROFILE"               VARCHAR2(4000) NULL      -- 프로필 사진
);
...
CREATE TABLE "POINT_CHARGE" (
	...
	"DATE"              DATE        DEFAULT SYSDATE NOT NULL  -- 포인트 충전 일시
);
...
CREATE TABLE "WARNING" (
	...
	"DATE"         DATE        DEFAULT SYSDATE NOT NULL , -- 경고 일시
	"USER_CODE"    VARCHAR2(20) NOT NULL  -- 사용자 식별 코드
);
...
CREATE TABLE "OUT" (
	...
	"DATE"      DATE        DEFAULT SYSDATE NOT NULL , -- 아웃 일시
	"USER_CODE" VARCHAR2(20) NOT NULL  -- 사용자 식별 코드
);
...
ALTER TABLE "R_POST"
	ADD
		CONSTRAINT "FK_USER_TO_R_POST" -- 사용자 등록 -> 렌트게시물 등록
		FOREIGN KEY (
			"USER_CODE" -- 작성한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
			"USER_CODE" -- 사용자 식별 코드
		);
...
ALTER TABLE "G_POST"
	ADD
		CONSTRAINT "FK_USER_TO_G_POST" -- 사용자 등록 -> 공통협력구매 게시물 등록
		FOREIGN KEY (
			"USER_CODE" -- 등록한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
			"USER_CODE" -- 사용자 식별 코드
		);
...
ALTER TABLE "J_POST"
	ADD
		CONSTRAINT "FK_USER_TO_J_POST" -- 사용자 등록 -> 자율협력구매 게시물 등록
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "RR_REQ"
	ADD
		CONSTRAINT "FK_USER_TO_RR_REQ" -- 사용자 등록 -> 역렌트 요청 게시물 등록
		FOREIGN KEY (
			"USER_CODE" -- 작성한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "RR_OFFER"
	ADD
		CONSTRAINT "FK_USER_TO_RR_OFFER" -- 사용자 등록 -> 역렌트 제공 게시물 등록
		FOREIGN KEY (
			"USER_CODE" -- 신청한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
			"USER_CODE" -- 사용자 식별 코드
		);
...
ALTER TABLE "REST"
	ADD
		CONSTRAINT "FK_USER_TO_REST" -- 사용자 등록 -> 휴면회원
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "SOSANG_APPLY"
	ADD
		CONSTRAINT "FK_USER_TO_SOSANG_APPLY" -- 사용자 등록 -> 소상공인회원 신청
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "LEAVE"
	ADD
		CONSTRAINT "FK_USER_TO_LEAVE" -- 사용자 등록 -> 탈퇴회원
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "ADV_APPLY"
	ADD
		CONSTRAINT "FK_USER_TO_ADV_APPLY" -- 사용자 등록 -> 광고신청(결제)
		FOREIGN KEY (
			"USER_CODE" -- 신청한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "G_APPLY"
	ADD
		CONSTRAINT "FK_USER_TO_G_APPLY" -- 사용자 등록 -> 공통협력구매 신청
		FOREIGN KEY (
			"USER_CODE" -- 신청한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "R_APPLY"
	ADD
		CONSTRAINT "FK_USER_TO_R_APPLY" -- 사용자 등록 -> 렌트 이용 신청
		FOREIGN KEY (
			"USER_CODE" -- 신청한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "J_APPLY"
	ADD
		CONSTRAINT "FK_USER_TO_J_APPLY" -- 사용자 등록 -> 자율협력구매 신청
		FOREIGN KEY (
			"USER_CODE" -- 신청한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "R_REPLY"
	ADD
		CONSTRAINT "FK_USER_TO_R_REPLY" -- 사용자 등록 -> 렌트 댓글작성
		FOREIGN KEY (
			"USER_CODE" -- 작성한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "RR_REPLY"
	ADD
		CONSTRAINT "FK_USER_TO_RR_REPLY" -- 사용자 등록 -> 역렌트 댓글 작성
		FOREIGN KEY (
			"USER_CODE" -- 작성한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "G_REPLY"
	ADD
		CONSTRAINT "FK_USER_TO_G_REPLY" -- 사용자 등록 -> 공통협력구매 댓글 작성
		FOREIGN KEY (
			"USER_CODE" -- 작성한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "J_REPLY"
	ADD
		CONSTRAINT "FK_USER_TO_J_REPLY" -- 사용자 등록 -> 자율협력구매 댓글 작성
		FOREIGN KEY (
			"USER_CODE" --  작성한 사용자 식별코드
		)
		REFERENCES "USER" ( -- 사용자 등록
			"USER_CODE" -- 사용자 식별 코드
		);
...
ALTER TABLE "J_REPLY_REPORT"
	ADD
		CONSTRAINT "FK_USER_TO_J_REPLY_REPORT" -- 사용자 등록 -> 자율협력구매 댓글 신고 
		FOREIGN KEY (
			"USER_CODE" -- 신고한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
			"USER_CODE" -- 사용자 식별 코드
		);
...
ALTER TABLE "J_POST_REPORT"
	ADD
		CONSTRAINT "FK_USER_TO_J_POST_REPORT" -- 사용자 등록 -> 자율협력구매 게시물 신고
		FOREIGN KEY (
			"USER_CODE" -- 신고한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "G_REPLY_REPORT"
	ADD
		CONSTRAINT "FK_USER_TO_G_REPLY_REPORT" -- 사용자 등록 -> 공통 협력 구매 댓글 신고 
		FOREIGN KEY (
			"USER_CODE" -- 신고한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "RR_OFFER_REPORT"
	ADD
		CONSTRAINT "FK_RR_OFFER_REPORT2" -- 사용자 등록 -> 역렌트 제공 게시물 신고
		FOREIGN KEY (
			"USER_CODE" -- 신고한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "RR_REQ_REPORT"
	ADD
		CONSTRAINT "FK_USER_TO_RR_REQ_REPORT" -- 사용자 등록 -> 역렌트 요청 게시물 신고
		FOREIGN KEY (
			"USER_CODE" -- 신고한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "CREDIT_SCORE"
	ADD
		CONSTRAINT "FK_USER_TO_CREDIT_SCORE" -- 사용자 등록 -> 신뢰도 점수 내역 등록
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "R_CATE_INPUT"
	ADD
		CONSTRAINT "FK_USER_TO_R_CATE_INPUT" -- 사용자 등록 -> 관심 렌트 카테고리 입력
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "CONNECTION"
	ADD
		CONSTRAINT "FK_USER_TO_CONNECTION" -- 사용자 등록 -> 접속일 관리
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "LOC"
	ADD
		CONSTRAINT "FK_LOC_TO_LOC" -- 사용자 지역 카테고리 -> 사용자 지역 카테고리
		FOREIGN KEY (
			"LOC_BCODE" -- 시/도 분류 코드
		)
		REFERENCES "LOC" ( -- 사용자 지역 카테고리
			"LOC_CODE" -- 사용자 지역 카테고리 식별 코드
		);
...
ALTER TABLE "LOC"
	ADD
		CONSTRAINT "FK_LOC_TO_LOC2" -- 사용자 지역 카테고리 -> 사용자 지역 카테고리2
		FOREIGN KEY (
			"LOC_MCODE" -- 시/군/구 분류 코드
		)
		REFERENCES "LOC" ( -- 사용자 지역 카테고리
			"LOC_CODE" -- 사용자 지역 카테고리 식별 코드
		);
...
ALTER TABLE "J_REPLY_LIKE"
	ADD
		CONSTRAINT "FK_USER_TO_J_REPLY_LIKE" -- 사용자 등록 -> 자율협력구매 댓글 좋아요
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "G_REPLY_LIKE"
	ADD
		CONSTRAINT "FK_USER_TO_G_REPLY_LIKE" -- 사용자 등록 -> 공통 협력 구매 댓글 좋아요
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "J_REAPPLY"
	ADD
		CONSTRAINT "FK_USER_TO_J_REAPPLY" -- 사용자 등록 -> 주문 수량 재입력
		FOREIGN KEY (
			"USER_CODE" -- 신청한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "R_REPLY_LIKE"
	ADD
		CONSTRAINT "FK_USER_TO_R_REPLY_LIKE" -- 사용자 등록 -> 렌트 댓글 좋아요
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "RR_REPLY_LIKE"
	ADD
		CONSTRAINT "FK_USER_TO_RR_REPLY_LIKE" -- 사용자 등록 -> 역렌트 댓글 좋아요
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "R_POST_REPORT"
	ADD
		CONSTRAINT "FK_USER_TO_R_POST_REPORT" -- 사용자 등록 -> 렌트 게시물 신고
		FOREIGN KEY (
			"USER_CODE" -- 신고한 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "CHUL_CHECK"
	ADD
		CONSTRAINT "FK_USER_TO_CHUL_CHECK" -- 사용자 등록 -> 출석체크
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "ALARM"
	ADD
		CONSTRAINT "FK_USER_TO_ALARM" -- 사용자 등록 -> 알림
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "FLLOW_LIST"
	ADD
		CONSTRAINT "FK_USER_TO_FLLOW_LIST" -- 사용자 등록 -> 팔로잉 목록
		FOREIGN KEY (
			"USER" -- 주체 아이디
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "FLLOW_LIST"
	ADD
		CONSTRAINT "FK_USER_TO_FLLOW_LIST2" -- 사용자 등록 -> 팔로잉 목록2
		FOREIGN KEY (
			"FLLOW" -- 팔로워 아이디
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "G_RECEIPT_FILE"
	ADD
		CONSTRAINT "FK_G_SUC_TO_G_REC_FILE" -- 공통협력구매 거래 성사 -> 영수증 첨부
		FOREIGN KEY (
			"G_SUCCESS_CODE" -- 공통협력구매 거래 성사 코드
		)
		REFERENCES "G_SUCCESS" ( -- 공통협력구매 거래 성사
...
ALTER TABLE "J_POST_JJIM"
	ADD
		CONSTRAINT "FK_USER_TO_J_POST_JJIM" -- 사용자 등록 -> 자율협력구매 게시물 찜
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "G_POST_JJIM"
	ADD
		CONSTRAINT "FK_USER_TO_G_POST_JJIM" -- 사용자 등록 -> 공통협력구매 게시물 찜
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "R_POST_JJIM"
	ADD
		CONSTRAINT "FK_USER_TO_R_POST_JJIM" -- 사용자 등록 -> 렌트 게시물 찜
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "RR_REQ_REPORT_PROC"
	ADD
		CONSTRAINT "FK_WAR_TO_RR_REQ_REPORT_PROC" -- 경고 내역 등록 -> 역렌트 요청 게시물 신고 처리
		FOREIGN KEY (
			"WARNING_CODE" -- 경고 내역 등록 코드
		)
		REFERENCES "WARNING" ( -- 경고 내역 등록
...
ALTER TABLE "JOIN"
	ADD
		CONSTRAINT "FK_USER_TO_JOIN" -- 사용자 등록 -> 회원 가입
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "JOIN"
	ADD
		CONSTRAINT "FK_LOC_TO_JOIN" -- 사용자 지역 카테고리 -> 회원 가입
		FOREIGN KEY (
			"LOC_CODE" -- 사용자 지역 카테고리 식별 코드
		)
		REFERENCES "LOC" ( -- 사용자 지역 카테고리
...
ALTER TABLE "POINT_LIST"
	ADD
		CONSTRAINT "FK_USER_TO_POINT_LIST" -- 사용자 등록 -> 포인트 내역 등록
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "BANANA_SCORE"
	ADD
		CONSTRAINT "FK_USER_TO_BANANA_SCORE" -- 사용자 등록 -> 바나나 점수 내역 등록
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "WARNING"
	ADD
		CONSTRAINT "FK_WARNING" -- 사용자 등록 -> 경고 내역 등록
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
...
ALTER TABLE "OUT"
	ADD
		CONSTRAINT "FK_OUT" -- 사용자 등록 -> 아웃 내역 등록
		FOREIGN KEY (
			"USER_CODE" -- 사용자 식별 코드
		)
		REFERENCES "USER" ( -- 사용자 등록
