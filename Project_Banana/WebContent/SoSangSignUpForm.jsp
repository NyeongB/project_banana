		...
		<div class="col-md-6">
			...
			<form class="form-inline" role="form">
				<div class="form-group">
					<label for="shopName"> 가게이름 </label> <input class="form-control" id="shopName" type="text" />
					<button class="btn btn-primary" type="submit">중복확인</button>
				</div>
				<br><br>
				<div class="form-group">
					<label for="shopLocation"> 가게위치 </label> <br> <input class="form-control" id="shopLocation" type="text" />
					- <input class="form-control" id="shopLocation" type="text" />
					<button class="btn btn-primary brTag" type="submit">우편번호</button>
					<br><br>
					<input class="form-control brTag" id="shopLocation" type="text" placeholder="주소" /><br>
					<input class="form-control" id="shopLocation" type="text" placeholder="상세주소" />
				</div>
				<br><br>
				<div class="form-group">
					<label for="sellItem"> 취급품목(카테고리) </label>
					<br>
				...
				<br><br>
				<div class="form-group">
					<label for="bankbookCopy"> 통장사본 </label>
				...
				<div class="form-group">
					<label for="businessNumFile"> 사업자 등록증 </label> 
