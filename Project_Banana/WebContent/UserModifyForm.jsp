		...
		<div class="row">
			<div class="col-md-12">
				<div class="row">
					...
					</div><!-- end MenuUser.jsp -->
					<div class="col-md-8"><!-- 개인정보수정시작 -->
							...
							<div class="header">
								<div class="col-md-12">
									...
									<div class="head_2">
										<div class="col-md-12">
											<br>
											<p class="text-center">회원가입을 통해 바나나 서비스를 이용하세요.</p>
									...
									<form role="form">
										...
										<div class="form-group">
											<div class="col-md-12">
												...
												<div class="col-md-2">
													<button type="button" class="btn btn-primary" type="submit">인증
														하기</button>
												</div>
												<div class="col-md-3"></div>
											</div>
										...
										<div class="form-group">
											<div class="col-md-12">
												<!-- 인증번호 -->
												<input type="text" name="num" id="num" placeholder="인증번호"
													class="form-control">
											</div>
										</div>
										<br>
										...
										<div class="form-group">
											<div class="col-md-12">
												<!-- 예금주 -->
												<input class="form-control" id="bank2" type="text"
													placeholder="예금주" />
											</div>
										</div>
										<br>
										...
										<div class="form-group">
											<div class="col-md-12">
												<!-- 계좌번호 -->
												<input class="form-control" id="banknum" type="text"
													placeholder="계좌번호" />
											</div>
										</div>
										<br>
