...
public class AdminShopUserListDTO
{
	private String name,ssn,tel,addr,id,email,sdate,bank_name,account_user,account,con_date,business_name,business_num;
	private int c_score,b_score,point,w_count,o_count;
