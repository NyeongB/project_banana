...
{
	private String name, ssn, addr, id, email;
	private String account_user, account, conDate; 
	private int point, banana_score, credit_score;
	private String tel,signDate;
	private String bank_name;
	private int out,warning;
